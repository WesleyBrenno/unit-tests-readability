...
public class ListPopulationTest {
    ...
    @Test
    public void testSetElitismRateThrowsOutOfRangeExceptionAndToString() throws Throwable {
        ...
        try {
            ...
            org.junit.Assert.fail("Expected exception of type math.exception.OutOfRangeException; message: elitism rate (-1)");
