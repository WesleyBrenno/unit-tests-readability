...
public class ListPopulationTest {
    ...
    @Test
    public void testSetPopulationLimitThrowsNotPositiveException() throws Throwable {
        ...
        math.genetics.ElitisticListPopulation elitisticListPopulation6 = new math.genetics.ElitisticListPopulation(100, 0.0d);
        ...
        boolean boolean9 = java.util.Collections.addAll((java.util.Collection<math.genetics.Chromosome>) chromosomeList8, chromosomeArray7);
        ...
        math.genetics.ElitisticListPopulation elitisticListPopulation14 = new math.genetics.ElitisticListPopulation(100, 0.0d);
        int int15 = elitisticListPopulation14.getPopulationLimit();
        math.genetics.ElitisticListPopulation elitisticListPopulation18 = new math.genetics.ElitisticListPopulation(100, 0.0d);
        ...
        boolean boolean21 = java.util.Collections.addAll((java.util.Collection<math.genetics.Chromosome>) chromosomeList20, chromosomeArray19);
        ...
        try {
            ...
            org.junit.Assert.fail("Expected exception of type math.exception.NotPositiveException; message: population limit has to be positive");
